...
*/
    private static final String APPLICATION_NAME = "chiragh";
    private static final JsonFactory JSON_FACTORY = JacksonFactory.getDefaultInstance();
    private static final String user = "me";
    static Gmail service = null;
    private static File filePath = new File(System.getProperty("user.dir") + "/credentials/credentials.json");
    ...
    public static Gmail getGmailService() throws IOException, GeneralSecurityException {
        ...
        Credential authorize = new GoogleCredential.Builder().setTransport(GoogleNetHttpTransport.newTrustedTransport())
                ...
                .build().setAccessToken(getAccessToken()).setRefreshToken(
                        "1//04WUZLZHHVuOHCgYIARAAGAQSNwF-L9IrM349fg-wU94OyrgQiX2_4maP-6JaPwyXZ-LNuTlhGi03tlk-Ogz-EPWmm8FJ4PYwxOs");//Replace this

        // Create Gmail service
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        service = new Gmail.Builder(HTTP_TRANSPORT, JSON_FACTORY, authorize).setApplicationName(GmailQuickStart1.APPLICATION_NAME).build();
    ...
    private static String getAccessToken() {
        ...
        try {
            ...
            params.put("client_id", "229677602711-j6oqtu9mntqqh4lq0sla3707sb57hnhc.apps.googleusercontent.com"); //Replace this
            params.put("client_secret", "kHUTmDhoD-A0coi_n8-7VGS1"); //Replace this
